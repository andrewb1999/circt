...
func.func @dot(%arg0: memref<64xi32>, %arg1: memref<64xi32>) -> i32 {
  ...
  // First stage.
  // CHECK: %[[STAGE0:.+]]:3 = loopschedule.at
...
func.func @dot_shared_mem(%arg0: memref<128xi32>) -> i32 {
  ...
  // Second stage.
  // CHECK: %[[STAGE1:.+]]:2 = loopschedule.at
