...
// CHECK-LABEL: calyx.component @minimal
func.func @minimal() {
...
// CHECK-LABEL: calyx.component @dot
func.func @dot(%arg0: memref<64xi32>, %arg1: memref<64xi32>) -> i32 {
  ...
  %0 = loopschedule.pipeline II = 1 trip_count = 5 iter_args(%arg2 = %c0, %arg3 = %c0_i32) : (index, i32) -> i32 {
    %s0:4 = loopschedule.at 0 -> (i32, i32, index, i1) {
      %a = loopschedule.load %arg0[%arg2 : index] : memref<64xi32>
      %b = loopschedule.load %arg1[%arg2 : index] : memref<64xi32>
...
// CHECK-LABEL: calyx.component @store
module {
  func.func @store(%arg0: memref<4xi32>, %arg1: memref<4xi32>) {
    ...
    loopschedule.pipeline II = 1 trip_count = 4 iter_args(%arg2 = %c0) : (index) -> () {
      %s0:4 = loopschedule.at 0 -> (i32, index, index, i1) {
        %v = loopschedule.load %arg0[%arg2 : index] : memref<4xi32>
        %nx = arith.addi %arg2, %c1 : index
      ...
      loopschedule.at 1 {
        loopschedule.store %s0#0, %arg1[%s0#1 : index] : memref<4xi32>
        loopschedule.store %s0#0, %arg1[%s0#1 : index] : memref<4xi32>
        loopschedule.yield
      }
...
module {
  func.func @main() {
    ...
    loopschedule.store %c1_i32, %alloca[%c0 : index] : memref<1xi32>
    return
  }
}
