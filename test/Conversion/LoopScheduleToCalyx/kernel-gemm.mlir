...
// XFAIL: *
// End-to-end gemm. Same failure as kernel-gemv.mlir: Calyx lowering does not
// support `!loopschedule.handle` results on frames produced by nested-loop
// launches.
// CHECK: calyx.component @gemm
